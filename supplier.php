    ...
    <div class="box-body">
          <?php
            ...
            switch($page){
              ...
              ?>
                <h1>List Supplier</h1>
                <p><a href="?p=supplier&page=entri" class="btn btn-primary"><i class=""></i>+ Tambah Data</a></p>
                <table class="table table-bordered text-center mt-3">
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="aksi_supplier.php?aksi=hapus&kode=<?php echo $row['id_supplier']?>" class="btn btn-danger pr-2 pl-2" ><i class="fas fa-trash mr-2"></i>Hapus
                        <a href="?p=supplier&page=edit&kode=<?php echo $row['id_supplier']?>" class="btn btn-primary ml-2 pr-2 pl-2"><i class="far fa-edit mr-2"></i>Edit
                        </td>
                    </tr>
                    <?php $i++;}?>
                </table>
                ...
                ?>
                    ...
                    <form class="form-group mt-5" method="post" action="aksi_supplier.php?aksi=tambah">
                        <div class="row mt-2">
                            <div class="col-md-2">
                                Nama Supplier
                            </div>
                            <div class="col-md-5">
                                <input type="text" name="nama_supplier" class="form-control" placeholder="Masukan Nama Supplier">
                            </div>
                        </div>
						<div class="row mt-2">
                            <div class="col-md-2">
                    ...
                    <?php
                        ...
                        case 'edit':
						$koneksi=mysqli_connect('localhost','root','','db_iventory');
                        $ambil = mysqli_query($koneksi,"select * from supplier where id_supplier='$_GET[kode]'");
                        $data = mysqli_fetch_array($ambil);
                    ?>
                    <h2>Edit Data Supplier</h2>
                    <form class="form-group mt-5" method="post" action="aksi_supplier.php?aksi=ubah&kode=<?php echo $data['id_supplier']?>">
                         <div class="row mt-2">
                            <div class="col-md-2">
                                Nama Supplier
                            </div>
                            <div class="col-md-5">
                                <input type="text" name="nama_supplier" class="form-control" placeholder="Masukan Nama Supplier" value="<?= $data['nama_supplier']?>">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-md-2">
